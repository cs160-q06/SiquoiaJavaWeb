        ...
        <form action="payment1.jsp" method="post">
            <div id="sink">
                <div class="well well-small">
                    ...
                    %>
                    Your choice: <b> <%=s%></b> topic
                </div>
                <div class="well well-small">	
                    Please select the preferred payment method from below: 
                    <hr />
                ...
                <div class="well well-small">
                    ...
                    <br />
                    Your point after purchasing = <%=point%> - <%=value%> = <b><%=after%></b>
                    <hr />
                    <input type="checkbox" name="check" value="check" > Agree to our <a href="#">Policies</a>
                    <br />
                    (Click agree then next to buy this packet)
                </div>
                <%
